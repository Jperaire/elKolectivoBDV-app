        ...
        <>
            <main>
                ...
                <section aria-labelledby="qui-som">
                    ...
                    <p>
                        El ꓘolectivo és un espai d’acompanyament, segur i
                        informatiu dirigit a persones del col·lectiu LGTBINBQ+ i
                        familiars que busquin suport, recursos i una comunitat a
                        Barberà del Vallès.
                    </p>
                    <p>
                ...
                <section aria-labelledby="que-fem">
                    ...
                    <ul>
                        <li>
                            Creem espais interns de suport mutu, segurs i càlids
                            per a totes les persones del col·lectiu.
                        </li>
                        <li>
                            Generem espais LGTBINBQ+ friendly oberts, inclusius
                            i lliures a Barberà.
                        </li>
                        <li>
                        ...
                        <li>
                            Sensibilitzem la població sobre la necessitat de
                            drets, espais i referents LGTBINBQ+.
                        </li>
                    </ul>
                </section>
